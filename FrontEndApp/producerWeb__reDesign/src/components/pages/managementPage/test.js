...
const spreadArray = (selectedFarm) => Object.entries(selectedFarm);
const func = defaultFarm => {
  var arr = []
  spreadArray(defaultFarm).map(([key, value]) => {
    arr = [...arr, value]
  })
  return arr
}
const unfilteredData = func(defaultFarm)
console.log(unfilteredData[0])
const keyArr = Object.keys(unfilteredData[0])
for (let i=0; i < keyArr.length(); i++) {
  console.log(unfilteredData[0].keyArr[i])
}